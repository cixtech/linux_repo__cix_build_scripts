...
while getopts "p:f:j:Mnvd:i:k:m:e:h:b:t:T:r:s:a:x:o:l:w:K:DHU:V:G:u:" opt; do
    ...
    ("v")
        ...
        export ftp_proxy="http://10.128.30.120:8111"
        #export no_proxy="localhost,localhost:*,127.*,*.cixcomputing.com,*.cixtech.com,*.cixcomputing.cn,10.128.*"
        export no_proxy="127.0.0.1,repo.cixcomputing.com,codereview.cixtech.com,repo.cixcomputing.cn,10.128.0.0/16,10.134.0.0/16,gitmirror.cixtech.com,gitmirror.cixcomputing.com,artifacts.cixtech.com,zj-artifacts.cixtech.com,ksh-artifacts.cixtech.com,wuh-artifacts.cixtech.com"
