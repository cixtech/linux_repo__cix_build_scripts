...
Description: $pkg_Name package"
    ...
    if [[ -e $PATH_ROOT/build-scripts/copyrights/copyright.$pkg_Name ]]; then
        mkdir -p $build_deb_dir/usr/share/doc/$pkg_Name
        cp $PATH_ROOT/build-scripts/copyrights/copyright.$pkg_Name $build_deb_dir/usr/share/doc/$pkg_Name/copyright
    fi
...
export PATH_DEBIAN_COMPILE_kylin_ffmpeg="${PATH_OUT}/kylin_ffmpeg"
